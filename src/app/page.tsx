    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-5xl px-6 py-16 grid items-center gap-10 md:grid-cols-2">
        <div className="space-y-5">
          ...
          <p className="text-black/70 dark:text-white/70">EuroLP Portal — PoC showcases a unified LP/VC portal with an aggregated view across all your funds. No real backend — hi believable mock data only.</p>
